...
public class eeg5 extends AppCompatActivity implements ViewTreeObserver.OnScrollChangedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eeg5);
    ...
    public void EEGRead (View view){
        Intent intent = new Intent(this, eeg6.class);
