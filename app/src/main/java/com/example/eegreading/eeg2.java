...
public class eeg2 extends AppCompatActivity implements ViewTreeObserver.OnScrollChangedListener{
    ScrollView sv_eeg;
    Button buttonpage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eeg2);
    ...
    public void EEGRead (View view){
        Intent intent = new Intent(this, eeg3.class);
